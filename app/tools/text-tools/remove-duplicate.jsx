...
import { removeDuplicates } from "../../../tool-functions/textTools";
...
const RemoveDuplicate = () => {
  ...
  return (
    <SafeAreaView>
      <Stack.Screen
        options={{
          headerTitle: "Remove Duplicates",
        }}
      />
      <Text fontSize={25}>Remove Duplicates</Text>
      <TextArea
        value={text}
