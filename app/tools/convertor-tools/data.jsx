...
import { convertData } from "../../../tool-functions/conversionTools";
...
const Data = () => {
  ...
  const startConvert = () => {
    if (fromValue.txtVal.trim() !== "" && fromValue.isValid) {
      let ans = convertData(fromValue.value, from, to);
      setToValue(ans);
    } else {
  ...
  return (
    <SafeAreaView>
      ...
      <VStack marginY={30} marginX={2} space={2} alignItems={"center"}>
        <Text fontSize={25}>Data Convertor</Text>
        <VStack
          borderWidth={3}
        ...
        >
          ...
          >
            <Select.Item label="Bit" value="bi" />
            <Select.Item label="KiloBit" value="kbi" />
            <Select.Item label="MegaBit" value="mbi" />
            <Select.Item label="GigaBit" value="gbi" />
            <Select.Item label="Byte" value="b" />
            <Select.Item label="KiloByte" value="kb" />
            <Select.Item label="MegaByte" value="mb" />
            <Select.Item label="GigaByte" value="gb" />
            <Select.Item label="TeraByte" value="tb" />
          </Select>
        </VStack>
