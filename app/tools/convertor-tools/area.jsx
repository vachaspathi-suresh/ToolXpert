...
import { convertArea } from "../../../tool-functions/conversionTools";
...
const Area = () => {
  ...
  const startConvert = () => {
    if (fromValue.txtVal.trim() !== "" && fromValue.isValid) {
      let ans = convertArea(fromValue.value, from, to);
      setToValue(ans);
    } else {
  ...
  return (
    <SafeAreaView>
      ...
      <VStack marginY={30} marginX={2} space={2} alignItems={"center"}>
        <Text fontSize={25}>Area Convertor</Text>
        <VStack
          borderWidth={3}
        ...
        >
          ...
          >
            <Select.Item label="Square KiloMeter" value="km" />
            <Select.Item label="Square Meter" value="m" />
            <Select.Item label="Square Inch" value="inch" />
            <Select.Item label="Square Foot" value="f" />
            <Select.Item label="Hectare" value="h" />
            <Select.Item label="Acre" value="acre" />
            <Select.Item label="Ares" value="ares" />
          </Select>
        </VStack>
