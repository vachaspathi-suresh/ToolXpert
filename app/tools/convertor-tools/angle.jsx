...
import { convertAngle } from "../../../tool-functions/conversionTools";
...
const Angle = () => {
  ...
  const startConvert = () => {
    if (fromValue.txtVal.trim() !== "" && fromValue.isValid) {
      let ans = convertAngle(fromValue.value, from, to);
      setToValue(ans);
    } else {
  ...
  return (
    <SafeAreaView>
      ...
      <VStack marginY={30} marginX={2} space={2} alignItems={"center"}>
        <Text fontSize={25}>Angle Convertor</Text>
        <VStack
          borderWidth={3}
        ...
        >
          ...
          >
            <Select.Item label="Degree" value="deg" />
            <Select.Item label="Radian" value="rad" />
            <Select.Item label="Gradian" value="grd" />
            <Select.Item label="Milliradian" value="mr" />
            <Select.Item label="Arc Second" value="sec" />
            <Select.Item label="Minute of arc" value="min" />
            <Select.Item label="Revolution" value="rev" />
          </Select>
        </VStack>
