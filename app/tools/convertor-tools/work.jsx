...
import { convertWork } from "../../../tool-functions/conversionTools";
...
const Work = () => {
  ...
  const startConvert = () => {
    if (fromValue.txtVal.trim() !== "" && fromValue.isValid) {
      let ans = convertWork(fromValue.value, from, to);
      setToValue(ans);
    } else {
  ...
  return (
    <SafeAreaView>
      ...
      <VStack marginY={30} marginX={2} space={2} alignItems={"center"}>
        <Text fontSize={25}>Work Convertor</Text>
        <VStack
          borderWidth={3}
        ...
        >
          ...
          >
            <Select.Item label="HorsePower" value="hp" />
            <Select.Item label="Watt" value="w" />
            <Select.Item label="MilliWatt" value="miw" />
            <Select.Item label="KiloWatt" value="kw" />
            <Select.Item label="MegaWatt" value="mw" />
            <Select.Item label="GigaWatt" value="gw" />
            <Select.Item label="Kilocalorie per Second" value="kcs" />
          </Select>
        </VStack>
        ...
        >
          ...
          >
            <Select.Item label="Joule per Second" value="js" />
            <Select.Item label="HorsePower" value="hp" />
            <Select.Item label="Watt" value="w" />
            <Select.Item label="MilliWatt" value="miw" />
            <Select.Item label="KiloWatt" value="kw" />
