...
import { convertTime } from "../../../tool-functions/conversionTools";
...
const Time = () => {
  ...
  const startConvert = () => {
    if (fromValue.txtVal.trim() !== "" && fromValue.isValid) {
      let ans = convertTime(fromValue.value, from, to);
      setToValue(ans);
    } else {
  ...
  return (
    <SafeAreaView>
      ...
      <VStack marginY={30} marginX={2} space={2} alignItems={"center"}>
        <Text fontSize={25}>Time Convertor</Text>
        <VStack
          borderWidth={3}
        ...
        >
          ...
          >
            ...
            <Select.Item label="Second" value="sec" />
            <Select.Item label="Hour" value="hr" />
            <Select.Item label="Day" value="d" />
            <Select.Item label="Week" value="w" />
            <Select.Item label="MilliSecond" value="ms" />
            <Select.Item label="NanoSecond" value="ns" />
          </Select>
        </VStack>
