...
import { convertVolume } from "../../../tool-functions/conversionTools";
...
const Volume = () => {
  ...
  const startConvert = () => {
    if (fromValue.txtVal.trim() !== "" && fromValue.isValid) {
      let ans = convertVolume(fromValue.value, from, to);
      setToValue(ans);
    } else {
  ...
  return (
    <SafeAreaView>
      ...
      <VStack marginY={30} marginX={2} space={2} alignItems={"center"}>
        <Text fontSize={25}>Volume Convertor</Text>
        <VStack
          borderWidth={3}
        ...
        >
          ...
          >
            <Select.Item label="Liter" value="l" />
            <Select.Item label="Cubic Meter" value="cm" />
            <Select.Item label="Milliliter" value="ml" />
            <Select.Item label="Cubic MilliMeter" value="cmm" />
            <Select.Item label="Gallon" value="g" />
            <Select.Item label="Cubic Foot" value="cf" />
            <Select.Item label="Cubic Inch" value="ci" />
          </Select>
        </VStack>
