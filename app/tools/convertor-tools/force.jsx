...
const Force = () => {
  ...
  const startConvert = () => {
    if (fromValue.txtVal.trim() !== "" && fromValue.isValid) {
      let ans = convertForce(fromValue.value, from, to);
      setToValue(ans);
    } else {
  ...
  return (
    <SafeAreaView>
      ...
      <VStack marginY={30} marginX={2} space={2} alignItems={"center"}>
        <Text fontSize={25}>Force Convertor</Text>
        <VStack
          borderWidth={3}
        ...
        >
          ...
          >
            <Select.Item label="Newton" value="n" />
            <Select.Item label="Joule per Centimeter" value="jc" />
            <Select.Item label="MegaNewton" value="mn" />
            <Select.Item label="Ton-Force" value="tf" />
            <Select.Item label="KiloNewton" value="kn" />
            <Select.Item label="Pound-Force" value="pf" />
            <Select.Item label="KiloGram-Force" value="kf" />
            <Select.Item label="Gram-Force" value="gf" />
          </Select>
        </VStack>
        ...
        >
          ...
          >
            <Select.Item label="Newton" value="n" />
            <Select.Item label="Joule per Meter" value="jm" />
            <Select.Item label="MegaNewton" value="mn" />
            <Select.Item label="Ton-Force" value="tf" />
            <Select.Item label="KiloNewton" value="kn" />
            <Select.Item label="Pound-Force" value="pf" />
